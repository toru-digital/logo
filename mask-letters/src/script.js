...
const mesh1 = new THREE.Mesh(new THREE.IcosahedronGeometry(1, 0), material);
...
// on scroll animate svg letters down in a random direction
gsap.to(".t", {
  duration: 5,
  x: -1,
  y: 30,
  ease: "power2.inOut",
  scrollTrigger: { trigger: ".t" , start:"top center", markers:true},
});
